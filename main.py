...
- Recursion works well for searching through types of structure (data structure) because it can search
  multiple branching paths without having many checks/conditions.
'''